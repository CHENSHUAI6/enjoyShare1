  ...
  data: {
    contactList:[
      ...
      },
      {
        ...
        showType: "contact-list_hidden",
      },
    ],

  },
  onQuery: function() {
    for(var j = 0,len=this.data.contactList.length; j < len; j++) {
      if (j == 1){
        this.data.contactList[j].showType = "contact-items_hidden";
      }else{
        this.data.contactList[j].showType = "contact-items";
      }
    }
    this.setData({
